...
const Services = () => {
  ...
  const mainServiceCategories = [
    {
      icon: Search,
      title: 'Диагностика машины и техобслуживание',
      services: [
        { name: 'Диагностика машины рядом (комплексная)', price: '1 500 ₽' },
        { name: 'Где заменить масло в авто - замена масла ДВС', price: '800 ₽' },
    ...
    {
      icon: Wrench,
      title: 'Автосервис для ремонта двигателя',
      services: [
    ...
    {
      icon: PaintBucket,
      title: 'Где отремонтировать кузов авто',
      services: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Полный спектр услуг: техобслуживание автомобиля, ремонт и обслуживание авто, диагностика машины, шиномонтаж в Зеленограде и Андреевке. Сколько стоит ТО в автосервисе - все цены указаны с учетом работы.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm">
            * Точная стоимость работ по ремонту и обслуживанию авто определяется после диагностики машины. Автосервис на карте в Зеленограде и Андреевке - автосервис рядом со мной.
          </p>
        </div>
      </div>
    </section>
